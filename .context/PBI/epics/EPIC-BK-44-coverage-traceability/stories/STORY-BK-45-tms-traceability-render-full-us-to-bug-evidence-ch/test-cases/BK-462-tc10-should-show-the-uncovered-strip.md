...
**Jira Key:** [BK-462](https://upexgalaxy71.atlassian.net/browse/BK-462)
**Status:** Candidate
...
Scenario: should show the "Uncovered · 0 ATCs bound" strip for an AC with no ATCs
  ...
  And a user story "{story_id}" in project "{project_slug}" with 1 or more covered ACs and at least 1 AC with zero bound ATCs
