...
**Jira Key:** [BK-464](https://upexgalaxy71.atlassian.net/browse/BK-464)
**Status:** Candidate
...
Scenario: should show "No coverage anywhere on this story" when a story has ACs but zero ATCs bound to any of them
  ...
  And a user story "{story_id}" in project "{project_slug}" with 1 or more ACs, none of which have any ATC bound
