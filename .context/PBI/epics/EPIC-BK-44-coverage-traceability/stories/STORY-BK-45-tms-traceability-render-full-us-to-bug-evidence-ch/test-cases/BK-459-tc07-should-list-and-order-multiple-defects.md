...
**Jira Key:** [BK-459](https://upexgalaxy71.atlassian.net/browse/BK-459)
**Status:** Candidate
...
Scenario: should list and order multiple defects linked to one run by created_at DESC
  ...
  And a user story "{story_id}" in project "{project_slug}" whose latest run has 2 or more linked defects with different creation timestamps
